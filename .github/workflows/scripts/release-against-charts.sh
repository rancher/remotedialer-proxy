...
#
# Example:
# ./release-against-charts.sh "${GITHUB_WORKSPACE}" "v0.2.0-rc.1" "v0.2.0-rc.2"

CHARTS_DIR=$1
PREV_REMOTEDIALER_VERSION=$2   # e.g. v0.2.0-rc.1
NEW_REMOTEDIALER_VERSION=$3    # e.g. v0.2.0-rc.2
...
# Validate the given remotedialer-proxy version (eg: 0.5.0-rc.13)
